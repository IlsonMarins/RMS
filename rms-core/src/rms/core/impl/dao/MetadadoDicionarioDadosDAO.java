...
public class MetadadoDicionarioDadosDAO extends AbstractJdbcDAO {

	public MetadadoDicionarioDadosDAO() {
	...
	public List<EntidadeDominio> consultar(EntidadeDominio entidade) throws SQLException {
		...
		try {
			...
			sql.append("FROM DBA_TABLES D, DBA_SEGMENTS S ");
			sql.append("WHERE D.TABLE_NAME = ? ");
			sql.append("AND S.SEGMENT_NAME = ? ");
			pst = connection.prepareStatement(sql.toString());
			pst.setString(1, tabela.getNomeTabela());
...
//		}
		...
		return entidades;
		}else{ // erro - entidade recebida diferente!
			return null;
		}
	} // fim-consultar()
}
